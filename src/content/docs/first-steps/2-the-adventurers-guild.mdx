...
For example, the first question is `write any number greater than 200`, but the code is currently saying `200 is smaller than ?`, instead of `? is greater than 200`.  
Remember to replace `?` in your final answer.
