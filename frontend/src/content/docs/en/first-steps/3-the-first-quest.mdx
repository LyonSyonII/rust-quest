...
---
<PortraitCard src="grocery">
Good morning Adventurer, I'm glad you've accepted my request.  
My age is starting to show and it's difficult to keep up with the work here at the store.  

Your first task is to help me keep track of the inventory, please, follow me.
</PortraitCard>
...
return (
  <CodeQuestion {...{question, code, setup, validator}} />
);
...
# Todo
- Canviar boxes a crates
- Arreglar problema primer exercici
- Fer que l'NPC parli