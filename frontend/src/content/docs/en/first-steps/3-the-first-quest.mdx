...
The man picks up a folded box and sets it on the ground.  
...
<Checkpoint id="3-3">
Having configured the box, you start walking to the counter to tell the Grocer your success, but then he shouts: <GT>Hey, adventurer! Bring me two apples from the box please</GT>.
...
Indeed, the panel is red, and says: <Highlight bg={colors.red}>Anti theft protection activated, if you want to change the contents of this box add the **`mut`** directive</Highlight>
