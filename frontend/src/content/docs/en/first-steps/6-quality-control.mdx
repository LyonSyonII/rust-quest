...
<Checkpoint id="6-1">
  ...
  See, the fisherman brings me different kinds of fish everyday, and writing new labels is a bit wasteful.  
  Could you program the boxes to recognize each species and set the price and name accordingly? 
  </Fish>
</Checkpoint>