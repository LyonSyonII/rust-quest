...
It's a request to add quality control directives to a few Magic Boxes™.  
</Guild>
...
<Fish>
I use these to keep the fish cold so it doesn't spoil, and when it's bad they automatically dispose of it.  
The boxes were working just fine until a few days ago, but now seem to function at random, and are discarding seemingly at random.
...
#### Freshness-Checking Magic Boxes™
This program checks the freshness of the contained fish, and automatically discards the ones that have spoiled.  
