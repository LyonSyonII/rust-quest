...
Congratulations on acquiring our Summoned Slime-Killing Robot!
...
The robot has a total of X possible actions:

| Action           | Description               |
| ---------------- | ------------------------- |
| `summon_robot()` | Activate the robot        |
| `shutdown()`     | Stop the robot            |
| `seek()`         | Locate and seek a target  |
| `attack()`       | Attack the nearest target |
| `defend()`       | Defend against attacks    |

#### 3. Legal and Ethical Considerations
- Adhere to local laws and regulations governing the use of slime-killing robots.
...
We wish you a happy slime extermination!


<RobotGame rows={5} cols={5} start={[0, 0]} enemies={[[1, 1], [2, 2], [3, 3], [4, 4]]}/>
</Checkpoint>
