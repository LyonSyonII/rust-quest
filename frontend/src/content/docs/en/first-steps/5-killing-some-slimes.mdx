...
:::note[Why the semicolons?]
All programming languages need a way to separate statements.  
Some do it with line breaks, Rust does it with semicolons.

It can be cumbersome at the start, but you'll get used to it in no time.
:::
...
<Comic src="robotpunch-opt" alt="robot punching slime" />
